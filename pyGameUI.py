...
"""
        some xtra things
        myColour = '#%02x%02x%02x' %(0,0,0)
        mycolour ='#00ff0088'
       button1.grid(row=0,column=0,sticky=W,padx=50,pady=50)
      button2.grid(row=0,column=2,padx=50)
     button3.grid(row=1,column=0,sticky = W,padx=50,pady = 100)
    button4.grid(row=1,column=2,padx=50,pady=50)
        scoreLabel.grid(row=3,column = 1)

        photo = PhotoImage(file="python_logo2.png")
